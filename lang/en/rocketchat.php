...
$string['overrideglobal_help'] = 'If you enabled override global message retention, the following retention value will be overridden. WARNING : 0 will trigger regular deletion of messages. global Rocket.Chat retention value.';
$string['filesonly'] = 'Prune files only, keep messages';
$string['filesonly_desc'] = 'if enabled, messages are not deleted, but files are; they are replaced by a simple File removed by automatic prune message. When used together with Exclude pinned messages, only unpinned files are deleted.';
